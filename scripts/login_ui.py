...
class Ui_loginWindow(object):
    def setupUi(self, loginWindow):
        ...
        self.label.setGeometry(QtCore.QRect(100, 50, 67, 17))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(loginWindow)
        self.label_2.setGeometry(QtCore.QRect(100, 90, 91, 17))
        ...
        self.confirmButton.setGeometry(QtCore.QRect(210, 150, 89, 25))
        self.confirmButton.setObjectName("confirmButton")
        self.clearButton = QtWidgets.QPushButton(loginWindow)
        self.clearButton.setGeometry(QtCore.QRect(100, 150, 89, 25))
        self.clearButton.setObjectName("clearButton")
        self.label_3 = QtWidgets.QLabel(loginWindow)
        self.label_3.setGeometry(QtCore.QRect(340, 216, 51, 71))
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap(":/iconos/iconos/univalle.png"))
        self.label_3.setScaledContents(True)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(loginWindow)
        self.label_4.setGeometry(QtCore.QRect(160, 220, 171, 61))
        self.label_4.setText("")
        self.label_4.setPixmap(QtGui.QPixmap(":/iconos/iconos/psi.png"))
